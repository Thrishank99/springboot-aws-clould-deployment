...
public class StudentServiceImpl implements StudentService {
	...
	/*
	 * @Override public Object[] getStudentToCollegeDetails() { // TODO
	 * Auto-generated method stub Object[]
	 * list=restTemplate.getForObject(ENDPOINT_URL, Object[].class); //Object[]
	 * list=restTemplate.getForObject("http://COLLEGE-MICROSERVICE/college/findAll",
	 * Object[].class); return list; }
	 * 
	 * @Override public Student saveStudentToCollegeDetails(Student student) { //
	 * TODO Auto-generated method stub return
	 * restTemplate.postForObject("http://COLLEGE-MICROSERVICE/college/save",
